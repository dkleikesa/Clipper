 ...
 */
private class AndroidClipboardPlatform(private val context: Context) : ClipboardPlatform {
    private val manager =
...
actual fun createClipboardPlatform(): ClipboardPlatform =
    ClipperAndroid.appContext?.let { AndroidClipboardPlatform(it) } ?: FallbackClipboardPlatform()
