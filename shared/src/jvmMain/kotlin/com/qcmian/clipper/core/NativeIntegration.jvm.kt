...
private class MacNativeIntegration : NativeIntegration {
...
actual fun createNativeIntegration(): NativeIntegration =
    if (isMacOs) MacNativeIntegration() else UnsupportedNativeIntegration
