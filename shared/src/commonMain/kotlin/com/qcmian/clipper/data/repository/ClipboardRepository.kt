 ...
 *
 * This is the data layer entry point: it owns persistence, the in-memory state exposed as
 * [StateFlow] and the access to the platform data sources. It deliberately contains no UI
 * state and no Compose dependency, so it can be reused by any presenter.
 */
